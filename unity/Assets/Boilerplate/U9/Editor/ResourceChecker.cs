...
public class ResourceChecker : EditorWindow {
	...
	int GetBitsPerPixel(TextureFormat format)
	{
		...
		Debug.Log ("WHAT FOrmati IS this?!: " + format);
		return 0;
	}
	...
	void CheckResources()
	{
		...
		SkinnedMeshRenderer[] skinnedMeshRenderers = (SkinnedMeshRenderer[])  Resources.FindObjectsOfTypeAll(typeof(SkinnedMeshRenderer));
