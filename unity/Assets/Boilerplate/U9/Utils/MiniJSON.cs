...
public class MiniJSON
{
	...
	private const int TOKEN_NAN = 12;
	...
	public static Vector3 DeserializeVector3( Hashtable t ) {
		return new Vector3( (float)(double)t["x"], (float)(double)t["y"], (float)(double)t["z"] );
	}
	
	public static Hashtable SerializeDateTime( DateTime t ) {
		Hashtable data = new Hashtable();
		data.Add("Year", (double)t.Year);
		data.Add("Month", (double)t.Month);
		data.Add("Day", (double)t.Day );
		data.Add("Hour", (double)t.Hour );
		data.Add("Minute", (double)t.Minute );
		data.Add("Second", (double)t.Second );
		return data;
	}
	
	public static DateTime DeserializeDateTime( Hashtable data ) {
		return new DateTime( (int)(double)data["Year"], (int)(double)data["Month"], (int)(double)data["Day"], (int)(double)data["Hour"], (int)(double)data["Minute"], (int)(double)data["Second"] );
	}

	public static Hashtable SerializeRect( Rect r ) {
		Hashtable t = new Hashtable ();
		t.Add ("xMin", (double)r.xMin);
		t.Add ("yMin", (double)r.yMin);
		t.Add ("width", (double)r.width);
		t.Add ("height", (double)r.height);
		return t;
	}

	public static Rect DeserializeRect( Hashtable t ) {
		return new Rect ( (float)(double)t["xMin"], (float)(double)t["yMin"], (float)(double)t["width"], (float)(double)t["height"]);
	}
	...
	public static Color DeserializeColor( Hashtable t ) {
		return new Color ( (float)(double)t["r"], (float)(double)t["g"], (float)(double)t["b"], (float)(double)t["a"]);
	}
	...
	protected static object parseValue( char[] json, ref int index, ref bool success )
	{
		switch( lookAhead( json, index ) )
		{
			...
			case MiniJSON.TOKEN_NULL:
				...
				nextToken( json, ref index );
				return null;
			case MiniJSON.TOKEN_NAN:
				Debug.Log ("FOUND a NaN");
				nextToken( json, ref index );
				return 0.0;
...
//			Debug.Log("Serializing - " + key + " : " + value.ToString() );
	...
	public static float ByteStringToFloat( string s ) {
